...
export function TaskDetailDialog({
  ...
  const renderComment = (c: TaskComment, depth: number = 0) => (
    <div key={c.id} className="group" style={{ marginLeft: depth > 0 ? 24 : 0 }}>
      <div className="flex gap-3 py-3" style={{ borderBottom: "1px solid #17181C" }}>
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <div className="flex flex-col md:flex-row h-full overflow-hidden">
          ...
          {/* ═══════════════════ ЛЕВАЯ КОЛОНКА ═══════════════════ */}
          <div className="flex-1 min-w-0 flex flex-col overflow-hidden" style={{ borderRight: "1px solid #17181C" }}>
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  {planfixUrl && (
                    <a href={planfixUrl} target="_blank" rel="noopener noreferrer"
                      ...
                      style={{ border: "1px solid #17181C", color: "#17181C" }}>
                  ...
                  <button className="flex items-center gap-1.5 text-xs font-semibold px-3 py-2 rounded-lg transition-colors bg-white"
                    style={{ border: "1px solid #17181C", color: "#C6453F" }}
            ...
            <div className="px-4 py-3">
              ...
              {(() => {
                ...
                const barColor = isClosed ? "#22c55e" : over ? "#ef4444" : "var(--tracker-accent)";
                return (
                <div className="mb-3 flex items-center gap-2 flex-wrap">
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      <button
                        ...
                        style={{ border: "1px solid #17181C", color: scolText(task.status, isDark) || "#17181C" }}
                      >
                        {task.status}
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <button
                        className="h-9 text-xs font-semibold rounded-lg px-3 inline-flex items-center gap-1.5 bg-white cursor-pointer hover:opacity-80 transition-opacity"
                        style={{ border: "1px solid #17181C", color: PCOL[task.priority] || "#17181C" }}
                      >
                        {task.priority}
                        <ChevronDown className="size-3.5 opacity-60" />
                      </button>
                  ...
                  <div className="flex items-center gap-2 flex-1 min-w-[160px] h-9 px-3 rounded-lg bg-white" style={{ border: "1px solid #17181C" }}>
            ...
            {monthBreakdown.length > 0 && (
              <div className="px-4 py-3 border-t" style={{ borderColor: "#17181C" }}>
                ...
                {/* Таблица */}
                <div className="rounded-xl overflow-hidden border text-xs" style={{ borderColor: "#17181C" }}>
                  <table className="w-full" style={{ borderCollapse: "collapse" }}>
                    ...
                    <tbody>
                      {monthBreakdown.map((r) => {
                        const over = r.cumulative > r.planH && r.planH > 0;
                        return (
                          <tr key={r.month} style={{ borderTop: "1px solid #17181C" }}>
                    ...
                    <tfoot>
                      <tr style={{ borderTop: "2px solid #17181C", background: "#FFFFFF" }}>
            ...
            <div className="px-4 py-3 border-t" style={{ borderColor: "#17181C" }}>
              ...
              <div className="rounded-xl p-3 mb-3 grid grid-cols-3 gap-3 text-center text-sm"
                style={{ background: "#FFFFFF", border: "1px solid #17181C" }}>
              ...
              <div className="flex items-center gap-3 mb-3">
                <input type="number" min={0} step={1} className="flex-1 h-9 rounded-xl border px-3 text-sm outline-none focus:ring-2 tabular-nums"
                  style={{ background: "var(--tracker-bg)", borderColor: "#17181C", color: "var(--tracker-text-main)" }}
              ...
              {budgetNum > 0 && (
                <div className="rounded-xl p-3 text-sm space-y-1.5" style={{ background: "var(--tracker-bg)", border: "1px solid #17181C" }}>
              ...
              {(task.totalBudgetRequested !== undefined) && (
                <div className="mt-3 pt-3 border-t space-y-1 text-xs" style={{ borderColor: "#17181C" }}>
          ...
          <div className="w-full md:w-[38%] md:min-w-[320px] flex flex-col overflow-hidden border-t md:border-t-0"
            ...
            {/* New comment input */}
            <div className="px-5 py-3 border-t shrink-0" style={{ borderColor: "#17181C" }}>
                      ...
                      <div key={i} className="relative group/att">
                        {att.startsWith("data:image/") ? (
                          ...
                          <span className="text-xs px-2 py-1 rounded-xl border flex items-center gap-1 h-16"
                            style={{ borderColor: "#17181C" }}><Paperclip className="size-3.5" /> Файл</span>
                        )}
