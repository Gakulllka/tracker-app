...
export const THEME_TO_PRES: Record<string, { emojis: string; pattern: "none"|"grid"|"diagonal"|"diamond"|"waves"|"zigzag"; emojiAnim: "off"|"drift"|"fall" }> = {
  "#F5F5F2": { emojis: "🚀 ✨ 💡 🎯 ⚡ 🎯 💼 📊",  pattern: "grid",  emojiAnim: "fall" },
  "#17181C": { emojis: "🚀 ✨ 💡 🎯 ⚡ 🎯 💼 📊",  pattern: "grid",  emojiAnim: "fall" },
  "#9B72CF": { emojis: "🚀 ✨ 💡 🎯 ⚡ 🎯 💼 📊",  pattern: "grid",  emojiAnim: "fall" },
  "#5B9BD5": { emojis: "🚀 ✨ 💡 🎯 ⚡ 🎯 💼 📊",  pattern: "grid",  emojiAnim: "fall" },
  "#4DB6AC": { emojis: "🚀 ✨ 💡 🎯 ⚡ 🎯 💼 📊",  pattern: "grid",  emojiAnim: "fall" },
  "#4FC3F7": { emojis: "🚀 ✨ 💡 🎯 ⚡ 🎯 💼 📊",  pattern: "grid",  emojiAnim: "fall" },
  "#66BB6A": { emojis: "🚀 ✨ 💡 🎯 ⚡ 🎯 💼 📊",  pattern: "grid",  emojiAnim: "fall" },
  "#9CCC65": { emojis: "🚀 ✨ 💡 🎯 ⚡ 🎯 💼 📊",  pattern: "grid",  emojiAnim: "fall" },
  "#D4A017": { emojis: "🚀 ✨ 💡 🎯 ⚡ 🎯 💼 📊",  pattern: "grid",  emojiAnim: "fall" },
  "#E8813A": { emojis: "🚀 ✨ 💡 🎯 ⚡ 🎯 💼 📊",  pattern: "grid",  emojiAnim: "fall" },
  "#E86B6B": { emojis: "🚀 ✨ 💡 🎯 ⚡ 🎯 💼 📊",  pattern: "grid",  emojiAnim: "fall" },
  "#E07BAD": { emojis: "🚀 ✨ 💡 🎯 ⚡ 🎯 💼 📊",  pattern: "grid",  emojiAnim: "fall" },
  "#7986CB": { emojis: "🚀 ✨ 💡 🎯 ⚡ 🎯 💼 📊",  pattern: "grid",  emojiAnim: "fall" },
  "#C49A6C": { emojis: "🚀 ✨ 💡 🎯 ⚡ 🎯 💼 📊",  pattern: "grid",  emojiAnim: "fall" },
  "#6B7280": { emojis: "🚀 ✨ 💡 🎯 ⚡ 🎯 💼 📊",  pattern: "grid",  emojiAnim: "fall" },
  "#0F766E": { emojis: "🚀 ✨ 💡 🎯 ⚡ 🎯 💼 📊",  pattern: "grid",  emojiAnim: "fall" },
  "#7C3AED": { emojis: "🚀 ✨ 💡 🎯 ⚡ 🎯 💼 📊",  pattern: "grid",  emojiAnim: "fall" },
  "#DB2777": { emojis: "🚀 ✨ 💡 🎯 ⚡ 🎯 💼 📊",  pattern: "grid",  emojiAnim: "fall" },
};
